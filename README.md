...
# - Start application service on http://172.15.1.207
...
API akan tersedia di `http://172.15.1.207`
...
- **Interactive API Docs**: `http://172.15.1.207/docs`
- **ReDoc Documentation**: `http://172.15.1.207/redoc`
- **OpenAPI Schema**: `http://172.15.1.207/openapi.json`
