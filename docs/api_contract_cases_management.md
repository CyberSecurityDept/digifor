...
**Example Request:**
```bash
curl -X POST "http://172.15.4.26/api/v1/auth/refresh" \
...
**Example Request:**
```bash
curl -X GET "http://172.15.4.26/api/v1/auth/me" \
...
```bash
curl -X POST "http://172.15.4.26/api/v1/auth/create-user" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..." \
  -H "Content-Type: application/json" \
  -d '{
...
1. Method: `POST`
2. URL: `http://172.15.4.26/api/v1/auth/create-user`
3. Headers:
...
**Example Request (cURL):**
```bash
curl -X PUT "http://172.15.4.26/api/v1/auth/update-user/4" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..." \
  -H "Content-Type: application/json" \
  -d '{
    "fullname": "Updated User Name",
...
**Example Request (cURL):**
```bash
curl -X DELETE "http://172.15.4.26/api/v1/auth/delete-user/4" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
...
```
GET http://172.15.4.26/api/v1/cases/get-case-detail-comprehensive/1
Authorization: Bearer <access_token>
```

**2. Get case detail dengan ID 2:**
```
GET http://172.15.4.26/api/v1/cases/get-case-detail-comprehensive/2
Authorization: Bearer <access_token>
```
...
```
PUT http://172.15.4.26/api/v1/cases/update-case/1
Authorization: Bearer <access_token>
Content-Type: application/json
...
```
PUT http://172.15.4.26/api/v1/cases/update-case/2
Authorization: Bearer <access_token>
Content-Type: application/json
...
```
PUT http://172.15.4.26/api/v1/cases/update-case/3
Authorization: Bearer <access_token>
Content-Type: application/json
...
**Example Request:**
```
POST http://172.15.4.26/api/v1/cases/save-notes
Authorization: Bearer {access_token}
Content-Type: application/json
...
```
PUT http://172.15.4.26/api/v1/cases/edit-notes
Authorization: Bearer {access_token}
Content-Type: application/json
...
**URL:**
```
http://172.15.4.26/api/v1/case-logs/case/logs/1
```
...
**Example Request (cURL):**
```bash
curl -X GET "http://172.15.4.26/api/v1/case-logs/case/logs/1?skip=0&limit=10" \
...
**URL:**
```
http://172.15.4.26/api/v1/case-logs/log/5
```
...
- Contoh URL yang benar: `http://172.15.4.26/api/v1/case-logs/log/5`
- Contoh URL yang salah: `http://172.15.4.26/api/v1/case-logs/log/5?Authorization=Bearer&Content-Type=application/json`

**Example Request (cURL):**
```bash
curl -X GET "http://172.15.4.26/api/v1/case-logs/log/5" \
  -H "Authorization: Bearer {access_token}" \
  -H "Content-Type: application/json"
```
...
**URL:**
```
http://172.15.4.26/api/v1/case-logs/change-log/1
```
...
**Example Request (cURL):**
```bash
curl -X PUT "http://172.15.4.26/api/v1/case-logs/change-log/1" \
  -H "Authorization: Bearer {access_token}" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "Closed",
...
2. **Set URL:** `http://172.15.4.26/api/v1/evidence/create-evidence`
3. **Tab Authorization:**
   - Type: `Bearer Token`
...
1. **Set Request Method:** `POST`
2. **Set URL:** `http://172.15.4.26/api/v1/persons/create-person`
3. **Tab Authorization:**
   - Type: `Bearer Token`
   - Token: `{{access_token}}` (or paste your access token)
4. **Tab Body:**
...
2. **Set URL:** `http://172.15.4.26/api/v1/persons/delete-person/{person_id}` (ganti `{person_id}` dengan ID person yang akan dihapus, contoh: `1`)
3. **Tab Authorization:**
   - Type: `Bearer Token`
   - Token: `{{access_token}}` (or paste your access token)
4. **Click Send**
