...
def run_migration():
    logger.info("🚀 Case Management Model Migration")
    logger.info("==================================================")
    logger.info("🔄 Migrating from UUID to Integer-based models")
    logger.info("==================================================")
    ...
    try:
        ...
        with engine.connect() as connection:
            ...
            connection.execute(text("DROP TYPE IF EXISTS case_status CASCADE"))
            connection.commit()
        ...
        for work_unit_data in work_units_data:
            ...
            db.add(work_unit)
        db.commit()
        logger.info("✅ Work units created")
        ...
        for case_data in cases_data:
            ...
            db.add(case)
        db.commit()
        logger.info("✅ Sample cases created")
        
        # Step 4: Test the new models
        logger.info("📝 Step 4: Testing new models...")
    ...
    logger.info("✅ New Integer-based models created")
